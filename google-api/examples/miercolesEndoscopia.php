<?php    
   ...
   $dias = array('Domingo','Lunes','Martes','Miercoles','Jueves','Viernes','Sabado');
     $link1=Conectarse();
            $sql1= " select * from reservaendoscopia  where DATETIME>=now() and DATETIME<= (now()+INTERVAL 7 day)  order by DATETIME";                              
      	...
      	$htmData="<head>";
            ...
            $htmData.="    <td height='149' align='rigth' style='font-family:Verdana, Geneva, sans-serif; font-size:12px;'>";
          	$htmData.="    <p style='font-size:14px;'> Turnos Endoscopia dia Miercoles <br>";
       ...
       $i ;    			
        ...
        $htmData.=" <font color='blue'>   <strong > NO POSEE TURNOS </strong><br><br></font>";
          ...
          $htmData.="    </p><p style='color:#473b2d;'>Muchas Gracias!</p>";
              ...
              $emailEnviar="raul.saiman@swissmedical.com.ar,martinalberto.blanco@swissmedical.com.ar,enlaceagote@swissmedical.com.ar,cinthiasole@yahoo.com.ar";
