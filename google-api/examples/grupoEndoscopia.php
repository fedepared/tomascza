     ...
     $link1=Conectarse();
      	...
      	$htmData="<head>";
            ...
            $htmData.="    <td height='149' align='rigth' style='font-family:Verdana, Geneva, sans-serif; font-size:12px;'>";
          	$htmData.="    <p style='font-size:14px;'> Turnos Endoscopia <br>";
       ...
       $fechaAnterior=""; 			
        ...
        {
          $fechaAnterior=$fecha;
          $htmData.="    <b><p style='font-size:18px;'> Turnos Dia ".$fecha." </p></b><br>";
        }
        ...
        if (($i % 2)==0)
          ...
          $htmData.="    </p><p style='color:#473b2d;'>Muchas Gracias!</p>";
              ...
              $emailEnviar="adege2000@yahoo.com.ar,cesar@didomenico.com.ar,mfpereyra79@gmail.com,ferabbott@hotmail.com,cinthiasole@yahoo.com.ar";
