	...
	<body>
    	<form method="post" action="frm_pacientes_proc.php">
        	...
        	<table>
            	...
            	<tr><td>Ocupaci�n:</td><td><input type="text" name="direccion" id="direccion" size="60"  value="<?php echo($direccion) ?>" /></td></tr>
            	<tr><td>Tel�fono:</td><td><input type="text" name="telefono" id="telefono" size="30" value="<?php echo($telefono) ?>"  /></td></tr>
