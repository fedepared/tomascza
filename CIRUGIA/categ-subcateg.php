...
<div id="page"> 
 ...
 <div id="central">
   ...
   <a href="abmCategorias.php?root=1"><img src="images/add.png" alt="Agregar" align="absmiddle" /> Agregar Categoria - Subcategoria</a><br><br>
   <!--Start FORM -->
   <form ACTION="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    ...
    <?php
    $link=Conectarse();
    $sql= " select * from menu_categorias  where root =1 and CD_MINITURISMO=0 ".$finalqry;
    
    $consulta= mysql_query($sql,$link);
    $sqlTotal = "SELECT count(*) as total from menu_categorias where root =1 and CD_MINITURISMO=0  ";
