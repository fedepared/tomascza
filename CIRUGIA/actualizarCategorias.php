...
if ($_POST["ID"]=='0')
{
	$query3 = "insert into  menu_categorias (categoria,descripcion,imagen,estado,orden,root,padre) 
			values ('".$_POST["PRO_CODIGO"]."','".$_POST["PRO_DESCRIPCION"]."','',1,
			".$_POST["PRO_CANTIDAD_DISPONIBLE"].",".$_POST["root"].",".$_POST["padre"].")";	
}
else 
{
...
if ($_POST["root"]=="1") 
	echo"<script language='javascript'>window.location='categ-subcateg.php'</script>;";
else 
