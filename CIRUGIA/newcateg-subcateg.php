...
<div id="page"> 
 ...
 <div id="central">
   ...
   <b><a href="categ-subcateg.php" >INICIO</a>
   <?php
   $link=Conectarse();
    $sqlBed= " 
    	select categoria
   ...
   ?></b>
 			 <br></br>
 			 <h1>Subcategorias </h1>
   <a href="abmCategorias.php?root=0&padre=<?php echo $idcategoria?>"><img src="images/add.png" alt="Agregar" align="absmiddle" /> Agregar Subcategorias</a><br><br>
   <!--Start FORM -->
   <form ACTION="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
    ...
    $sql= " select * from menu_categorias  where padre =".$idcategoria." ".$finalqry;
  ...
  <td>
    	<img src="images/edit.png" alt="Modificar" align="absmiddle" /><a href="abmCategorias.php?id=<?php echo $row["id"] ?>&root=0&padre=<?php echo $idcategoria ?>" > Modificar</a>
  </td>
  <td>
    	<img src="images/edit.png" alt="Eliminar" align="absmiddle" /><a href="newcateg-subcateg.php?mde=<?php echo $row["id"] ?>&md=<?php echo $idcategoria ?>" > Eliminar</a>
  </td>
  </tr>  	<?php 
    }}     
     ?>
 ...
 <!-- paginacion
  -->
    ...
    <br></br>
	<h1>Productos </h1>
	<a href="abmProcductos.php?padre=<?php echo $idcategoria?>"><img src="images/add.png" alt="Agregar" align="absmiddle" /> Agregar Producto</a><br><br>	
  ...
  <td>
    	<img src="images/edit.png" alt="Modificar" align="absmiddle" /><a href="abmProcductos.php?id=<?php echo $row1["ID"] ?>&padre=<?php echo $idcategoria ?>"> Modificar</a>
  </td>
  <td>
    	<img src="images/edit.png" alt="Eliminar" align="absmiddle" /><a href="newcateg-subcateg.php?elpro=<?php echo $row1["ID"] ?>&md=<?php echo $idcategoria ?>" > Eliminar</a>
  </td>
  </tr>
    	<?php 
    } }    
