 ...
 <div id="central">
  ...
  <form ACTION="actualizarslider.php" METHOD="POST" enctype="multipart/form-data">
    <input type="hidden" name="ID" id="ID" value="<?php echo $Id ?>"></input>
     <table class="form" border="0"  align="center">
        <tr>
          ...
          <tr>
                    <td class="formTitle" align="left">Comentario</td>
            <td align="left">
                <input type="text" name="DESCRIPCION" id="DESCRIPCION" class="campos"/>
            </td>
          </tr>
          <tr>
                    <td class="formTitle" align="left">Mensaje Link</td>
            <td align="left">
                <input type="text" name="LINK" id="LINK" class="campos"/>
            </td>
          </tr>
          <tr>

          
            <td class="formTitle" align="left">Subir Foto Slider </td>
            <td align="left">
   ...
   <form ACTION="<?php echo $_SERVER['PHP_SELF']; ?>" METHOD="POST" enctype="multipart/form-data">    
    ...
    $link=Conectarse();
    $sql= " select * from sliders ".$finalqry;
    
    $consulta= mysql_query($sql,$link);
    $sqlTotal = "SELECT count(*) as total from sliders ";
    ...
    {?>
    <tr class="rowBlanco">
    	<td class="formFields"> <?php echo $row["slider"] ?></td>
    	<td class="formFields"> <?php echo $row["imagen"] ?></td>
  
  <td>
    	<img src="images/edit.png" alt="Eliminar" align="absmiddle" /><a href="abmSliders.php?mde=<?php echo $row["id"] ?>" > Eliminar</a>
  </td>
  </tr>
    	<?php 
    }     
