...
$_pagi_cuantos = 6;//Elegí un número pequeño para que se generen varias páginas

$_pagi_nav_num_enlaces = 4;//Elegí un número pequeño para que se note el resultado
...
$_pagi_nav_anterior = "<i class='fa fa-angle-left'></i>";// podría ir un tag <img> o lo que sea

$_pagi_nav_siguiente = "<i class='fa fa-angle-right'></i>";// podría ir un tag <img> o lo que sea
 ...
 */
 ...
 if(empty($sql)){
	...
	die("<b>Error Paginator : </b>No se ha definido la variable \$sql");
 ...
 if(!isset($_pagi_nav_primera)){
	...
	$_pagi_nav_primera = "<i class='fa fa-angle-double-left'></i>";
 ...
 if(!isset($_pagi_nav_ultima)){
	...
	$_pagi_nav_ultima = "<i class='fa fa-angle-double-right'></i>";
 ...
 */
 ...
 if($_pagi_conteo_alternativo == false){
 	...
 	$_pagi_sqlConta = eregi_replace("select[[:space:]](.*)[[:space:]]from", "SELECT COUNT(*) FROM", $sql);

 	$_pagi_result2 = $db->Query($_pagi_sqlConta,$connection);
	...
	$_pagi_result3 = $db->Query($sql,$connection);

	// Si ocurrió error y mostrar errores está activado

 	if($_pagi_result3 == false && $_pagi_mostrar_errores == true){

		die (" Error en la consulta de conteo alternativo de registros: $sql. Mysql dijo: <b>".mysql_error()."</b>");
 ...
 */
 ...
 if ($_pagi_actual != 1){
	...
	$_pagi_navegacion_temporal[] = "<li><a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."&id_subcate=".$id_subcate."'>$_pagi_nav_primera</a></li>";
	...
	$_pagi_navegacion_temporal[] = "<li><a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."&id_subcate=".$id_subcate."'>$_pagi_nav_anterior </a></li>";
 ...
 for ($_pagi_i = $_pagi_nav_desde; $_pagi_i<=$_pagi_nav_hasta; $_pagi_i++){//Desde página 1 hasta última página ($_pagi_totalPags)
	...
	if ($_pagi_i == $_pagi_actual) {
		...
		$_pagi_navegacion_temporal[] = "<li class='active first-bg-hover'><a href='#'>$_pagi_i</a></li>";

	}else{

		// Si es cualquier otro. Se escibe el enlace a dicho número de página.

		$_pagi_navegacion_temporal[] = "<li><a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_i."&id_subcate=".$id_subcate."'>".$_pagi_i."</a></li>";
 ...
 if ($_pagi_actual < $_pagi_totalPags){
	...
	$_pagi_navegacion_temporal[] = "<li><a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."&id_subcate=".$id_subcate."'>$_pagi_nav_siguiente</a></li>";
	...
	$_pagi_navegacion_temporal[] = "<li><a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."&id_subcate=".$id_subcate."'>$_pagi_nav_ultima</a></li>";
 ...
 */
 ...
 $_pagi_sqlLim = $sql." LIMIT $_pagi_inicial,$_pagi_cuantos";

 $_pagi_result = $db->Query($_pagi_sqlLim,$connection);
