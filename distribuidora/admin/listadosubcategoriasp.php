...
$sql = " SELECT id_subcate , nombre, publicado from tbl_subcategorias2 where nombre like '%".$palabra."%'";

$sql = " SELECT TC.id_subcate , TC.nombre, TC.publicado, TCM.nombre as categoria from tbl_subcategorias2 as TC, tbl_subcategorias as TCM where TC.nombre like '%".$palabra."%' and TC.id_cate = TCM.id_subcate ORDER by TCM.nombre asc";
...
<div class="col-md-10 main">
      <h1 class="page-header"><i class="fa fa-folder-open"></i>&nbsp;Listado de Sub - Nivel 2</h1>   
      <div class="row">
        <div class="col-md-5">
          <p> <a href="a_subcatep.php" class="btn btn-success">Nuevo Producto</a> <a href="#" onClick="juntochecks()" class="btn btn-danger ">Borrar seleccionados </a></p>
        </div>
        <div class="col-md-5 pull-right">
        <? echo buscador('listadosubcategoriasp.php') ?>
        </div>
        <div class="col-md-12">
        <? if ($palabra != "") {
...
<table class="table table-bordered table-striped">
  <form name="frmlistado" method="post" action="b_subcatep.php">
    ...
    <? 
							if ($db->CantidadFilas($result) > 0)  {
									...
									$leditar="e_subcatep.php?id_subcate=$myrow[id_subcate]";
									$lborrar="b_subcatep.php?id_subcate=$myrow[id_subcate]";
							?>
    <tr>
    ...
    <? 		
									...
									echo "<tr><th class='text-center' colspan='4'><p>Actualmente no existen productos.</p></th></tr>";
								}
								?>
  </form>
</table></div>
