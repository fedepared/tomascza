...
if ($HttpVars->TraerPost('envio') != '') { 
	...
	$sql="update tbl_subcategorias2 set 
	id_cate = ". $id_cate ." ,
	nombre = '".htmlentities($nombre)."' 
	where id_subcate =".$id_subcate."";
	$result = $db->Query($sql,$connection);
	header("Location:listadosubcategoriasp.php?modificado=1");

} else {
	$sql="select nombre,id_cate from tbl_subcategorias2 where id_subcate = ".$id_subcate."";
	$result = $db->Query($sql,$connection);;
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-10 main">
      <h1 class="page-header"><i class="fa fa-folder-open"></i>&nbsp;Editar Sub-Nivel 2</h1>
      <form method="POST" action="e_subcatep.php" onSubmit="return validaCampos(this)">
        <?	
		...
		<select name="cmbcate">
									<?
									$sql = " SELECT id_subcate as id_cate , nombre from tbl_subcategorias";
									$result = $db->Query($sql,$connection);
