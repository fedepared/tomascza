...
if ($HttpVars->TraerPost('envio') != '') { 
  ...
  $orden = $HttpVars->TraerPost('orden') ;
	...
	$sql="SELECT nombre from tbl_categorias where nombre = '" . $nombre . "' and id_catemaster = ".$idcatemaster."";
	//echo $sql;
	...
	if ($db->CantidadFilas($result) > 0) { 
		...
		$sql="INSERT into tbl_categorias(id_catemaster,nombre,publicado,orden)  VALUES (".$idcatemaster.",'".htmlentities($nombre)."',".$chkpubli.",".$orden.")";
		$result = $db->Query($sql,$connection);
		$agregada = 1;
		$nombre = "" ;
	}
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-10 main">
      ...
      <form method="POST" action="a_cate.php" onSubmit="return validaCampos(this)">
        <?	
