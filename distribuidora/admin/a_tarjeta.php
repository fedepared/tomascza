...
$sql="SELECT * from tbl_tarjetas where nombre= '" . $nombre . "'";
	...
	if ($db->CantidadFilas($result) > 0) { 
		...
		if (isset($_FILES["imgch"])) {
                ...
                $sql="INSERT into tbl_tarjetas( nombre, pathch, filech, link, target, publicado)  VALUES " . 
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-10 main">
      <h1 class="page-header"><i class="fa fa-picture-o"></i>&nbsp;Agregar Tarjeta</h1>
      <div id="mensaje"></div>
      <?	
					echo agregada($agregada,$imagespath,'banner','listadotarjetas.php');
