...
if ($HttpVars->TraerPost('envio') != '') { 
	...
	$sql="SELECT general from tbl_general where general = '" . $nombre . "' ";
	//echo $sql;
	...
	if ($db->CantidadFilas($result) > 0) { 
		...
		$sql="INSERT into tbl_general(general, publicado)  VALUES ('".htmlentities($nombre)."',".$chkpubli.")";
		$result = $db->Query($sql,$connection);
		$agregada = 1;
		$nombre = "" ;
		$codcolor = "" ;
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-10 main">
      ...
      <form method="POST" action="a_general.php" onSubmit="return validaCampos(this)">
        <?	
