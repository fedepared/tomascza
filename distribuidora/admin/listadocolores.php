...
$sql = " SELECT TC.id_color , TC.color, TC.codigo_color, TC.publicado from tbl_colores as TC where TC.color like '%".$palabra."%' ";
...
<div class="col-md-10 main">
      <h1 class="page-header"><i class="fa fa-folder"></i>&nbsp;Listado de Colores</h1>   
      <div class="row">
        <div class="col-md-5">
          <p> <a href="a_color.php" class="btn btn-success">Nuevo Color</a> <a href="#" onClick="juntochecks()" class="btn btn-danger ">Borrar seleccionados </a></p>
        </div>
